...
// import { exercisePlaylist, naturePlaylist, relaxingPlaylist } from "./music"
...
// export const sleepstories: Song[] = [
//   {
//     ...songData[0],
...
// const SleepScreen = () => {
//   const { playSong, clearQueue, isLoading: playerIsLoading, errorMessage, addToQueue } = useMusicPlayer()
...
//   // Display any error messages from the music player context
//   useEffect(() => {
//     if (errorMessage) {
...
//   // Handle playing a sleep song
//   const handleSleepItemPress = useCallback(
//     async (song:any) => {
//       if (isProcessing || playerIsLoading) return

//       setIsProcessing(true)
//       setError(null)
//       try {
//         // Clear any current queue
//         await clearQueue()
//         // Play the selected sleep song
//         await playSong(song)
//       } catch (err) {
//         console.error("Error playing sleep song:", err)
//         setError("Could not start playback")
//       } finally {
//         setIsProcessing(false)
//       }
//     },
//     [isProcessing, playerIsLoading, clearQueue, playSong]
//   )

//   const isLoading = isProcessing || playerIsLoading
...
//             <TouchableOpacity
//               key={index}
//               className={`bg-primary_dark rounded-3xl overflow-hidden border-2 ${
//                 isAnyLoading ? "border-gray-700/30" : "border-white/20"
//               }`}
//               onPress={() => handleSleepItemPress(item)}
//               disabled={isAnyLoading}
...
//                     className="text-white text-heading font-semibold mb-1"
//                   >
//                     {item.title}
//                   </Text>
